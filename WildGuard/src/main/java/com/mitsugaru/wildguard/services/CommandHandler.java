...
public abstract class CommandHandler implements CommandExecutor {
    ...
    */
   protected final Map<String, IWildCommand> registeredCommands = new HashMap<String, IWildCommand>();
   /**
    ...
    *           - Root plugin.
    */
   public CommandHandler(WildGuard plugin, String cmd) {
      this.plugin = plugin;
      this.cmd = cmd;
   }
    ...
    *           command.
    */
   public void registerCommand(String label, IWildCommand command) {
   ...
   public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
      if(args.length == 0) {
         ...
         final IWildCommand subCommand = registeredCommands.get(subcmd);
         if(subCommand == null) {
